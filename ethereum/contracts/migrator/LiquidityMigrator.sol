...
contract LiquidityMigrator {
    ...
    constructor(address _router, address _pair, address _routerFork, address _pairFork, address _bonusToken) public {
    ...
    function deposit(uint amount) external {
        ...
        bonusToken.mint(msg.sender, amount); // give same amount of rewards as the number of LP token deposited to make it simple
